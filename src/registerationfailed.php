...
<body>
    ...
    <br/>
    <!--report failed registeration -->
    <div id="failureMsg" class="mainbox">
        <p>
            <?php echo "User name, passportID, e-mail or tel already occupied or invalid inputs. Registeration failed.";?>
            <a href="customerregister.php"><br/>Try again</a>
        </p>
    </div>
